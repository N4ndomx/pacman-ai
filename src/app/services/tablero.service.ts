...
export class TableroService {
  private apiUrl = 'http://127.0.0.1:8000/generate_map';
  oneBlockSize = 21;
  wallSpaceWidth = this.oneBlockSize / 1.6;
  wallOffset = (this.oneBlockSize - this.wallSpaceWidth) / 3;
  ...
  async getMapAPI(): Promise<void> {
    ...
    this.bolitas_totales = this.bolitas_ganar()
    // console.log(this.map)
  }

  bolitas_ganar(): number {
    let count = 0;
